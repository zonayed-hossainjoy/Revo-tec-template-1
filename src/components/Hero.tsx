        ...
        <div className="w-full flex flex-col md:grid md:grid-cols-3 gap-8 items-stretch">
          ...
          <div className="flex flex-col gap-6 order-2 md:order-1">
            ...
            <div className="bg-[#F3F4F6] dark:bg-[#111827] rounded-[24px] p-6 md:p-8 shadow-sm border border-gray-100 dark:border-gray-800/80 transition-colors duration-300 min-h-[265px] flex flex-col justify-center">
              <p className="text-gray-800 dark:text-gray-300 text-base md:text-lg leading-relaxed">
                <strong>Revo-Tec</strong> is an <span className="text-[#F84B4B] font-semibold">Austrian</span> pioneer in high-end Smart Home and IoT engineering. We combine industrial-grade reliability with intuitive design to give you total control over your environment.
              </p>
            </div>
            ...
            <div className="bg-[#F3F4F6] dark:bg-[#111827] rounded-[24px] p-8 shadow-sm border border-gray-100 dark:border-gray-800/80 flex flex-col items-center justify-center min-h-[300px] transition-colors duration-300 mt-auto">
              ...
              <p className="text-gray-800 dark:text-gray-200 text-sm md:text-base font-semibold tracking-wide uppercase">Control Series</p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center order-1 md:order-2 relative h-full pt-8 md:pt-0">
            ...
            <p className="text-[#99BB42] text-[10px] md:text-[11px] font-bold uppercase tracking-[0.3em] mb-4 z-20">Revo-Tec Mobile App</p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 w-full justify-center px-4 md:px-0">
                <button className="flex items-center justify-center gap-3 border border-primary/30 dark:border-gray-700 bg-white/80 dark:bg-[#1f2937] backdrop-blur-sm rounded-2xl px-5 py-3 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all shadow-sm flex-1">
                   ...
                   <div className="text-left flex flex-col">
                     <span className="text-[10px] text-gray-500 dark:text-gray-400 font-medium leading-tight">Download On The</span>
                     <span className="text-sm font-bold text-black dark:text-white leading-tight">App Store</span>
                   </div>
                </button>
                <button className="flex items-center justify-center gap-3 border border-primary/30 dark:border-gray-700 bg-white/80 dark:bg-[#1f2937] backdrop-blur-sm rounded-2xl px-5 py-3 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all shadow-sm flex-1">
                   ...
                   <div className="text-left flex flex-col">
                     <span className="text-[10px] text-gray-500 dark:text-gray-400 font-medium leading-tight">Get It On</span>
                     <span className="text-sm font-bold text-black dark:text-white leading-tight">Google Play</span>
                   </div>
                </button>
              </div>
            </div>
          ...
          <div className="flex flex-col gap-6 order-3 md:order-3">
            ...
            <div className="bg-[#F3F4F6] dark:bg-[#111827] rounded-[24px] p-8 shadow-sm border border-gray-100 dark:border-gray-800/80 flex flex-col items-center justify-center min-h-[300px] relative transition-colors duration-300">
              ...
              <p className="text-gray-800 dark:text-gray-200 text-sm md:text-base font-semibold tracking-wide uppercase mt-auto">View Series</p>
            </div>
            ...
            <div className="bg-[#F3F4F6] dark:bg-[#111827] rounded-[24px] p-8 shadow-sm border border-gray-100 dark:border-gray-800/80 flex flex-col items-center justify-center min-h-[300px] transition-colors duration-300 mt-auto">
              ...
              <p className="text-gray-800 dark:text-gray-200 text-sm md:text-base font-semibold tracking-wide uppercase mt-auto">Sensor Series</p>
            </div>
          </div>
